...
@PrepareForTest(PullRequestOpenedEvent.class)
public class PullRequestOpenedListenerTest {

  private Notifier notifier;
  private EligibilityFilterChain filterChain;
  private PullRequestOpenedListener listener;
  private SettingsService settingsService;
  private PullRequestOpenedEvent event;
  ...
  public void setup() throws Exception {
    ...
    event = mock(PullRequestOpenedEvent.class);
    ...
    listener = new PullRequestOpenedListener(filterChain, notifier,
        settingsService);
  }
